# asc-ImageJ-DSX-Stitching-Utilities
	...
	<em>All the macros in this repository require that the <a href="https://imagej.net/plugins/exif-reader.html">exifReader</a> plugin has previously been installed.</em>
